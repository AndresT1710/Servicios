                    ...
                    <div class="modal-body">
                        <form role="form" action="" method="post" class="registration-form" id="formEditar">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="Nombre..." class="form-first-name form-control" id="nameE">
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="sr-only" for="lastNameE">Apellido: </label>
                                <input type="text" name="lastName" placeholder="Apellido..." class="form-last-name form-control" id="lastNameE">
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="sr-only" for="ageE">Edad: </label>
                                <input type="text" name="age" placeholder="Edad..." class="form-email form-control" id="ageE">
                            </div>
                            <br>
                    ...
                    <div class="modal-body">
                        <form role="form" action="" method="" class="registration-form" id="formAgregar">
                            <div class="form-group">
                                ...
                                <input type="text" name="dniA" placeholder="Cedula..." class="form-first-name form-control" id="dniA">
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="sr-only" for="nameA">Nombre: </label>
                                <input type="text" name="nameA" placeholder="Nombre..." class="form-first-name form-control" id="nameA">
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="sr-only" for="lastNameA">Apellido: </label>
                                <input type="text" name="lastNameA" placeholder="Apellido..." class="form-last-name form-control" id="lastNameA">
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="sr-only" for="ageA">Edad: </label>
                                <input type="text" name="ageA" placeholder="Edad..." class="form-email form-control" id="ageA">
                            </div>
                            <br>
